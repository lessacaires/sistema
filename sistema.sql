...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 29-Nov-2022 às 02:25
...
(1, 'Cartão de Débito', 2, 1, '2022-04-30 18:08:31'),
(2, 'Dinheiro', 1, 1, '2022-04-30 21:24:48'),
(4, 'Cartão de Crédito', 1, 1, '2022-04-30 19:11:40'),
(6, 'Boleto Bancário', 1, 1, '2022-04-30 20:57:53');
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1 COMMENT='Tabela de relacionamento entre as tabelas servicos e ordem_servico';
...
(6, 2, 2, 4, ' 80.00', '0 ', ' 320.00'),
(13, 1, 1, 1, ' 80.00', '0 ', ' 80.00'),
(14, 2, 1, 1, ' 80.00', '0 ', ' 80.00'),
(15, 3, 1, 1, ' 120.00', '0 ', ' 120.00');
...
(1, 1, 2, '2020-02-14 20:30:35', NULL, 'Fone de ouvido', 'Awell', 'AV1801', 'Mouse e carregador', 'Não sai aúdio no lado esquerdo', 'R$ 0.00', '280.00', 0, 'Orçamento autorizado.', '2022-05-01 18:58:09'),
(2, 1, 2, '2020-02-14 20:48:53', NULL, 'Notebook gamer', 'Awell', 'FONE01', 'Mouse e carregador', 'Não carrega', 'R$ 0.00', '320.00', 0, '', '2022-05-01 17:19:47'),
...
--
-- Estrutura da tabela `passeios`
--

DROP TABLE IF EXISTS `passeios`;
CREATE TABLE IF NOT EXISTS `passeios` (
  `id` int NOT NULL AUTO_INCREMENT,
  `passeio_nome` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `passeio_descricao` text NOT NULL,
  `passeio_preco` double NOT NULL,
  `passeio_trajeto` tinyint(1) NOT NULL,
  `passeio_ocupantes` int NOT NULL,
  `passeio_status` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Extraindo dados da tabela `passeios`
--

INSERT INTO `passeios` (`id`, `passeio_nome`, `passeio_descricao`, `passeio_preco`, `passeio_trajeto`, `passeio_ocupantes`, `passeio_status`) VALUES
(1, 'Teste de cadastro de passeio', 'Teste de cadastro de passeio', 200, 1, 0, 1);
...
(1, '127.0.0.1', 'administrator', '$2y$10$0zGLcOqh9NvPEz2FaKlLNexF9beC7dE51BrYkEKOqTAiUGDqLtOMu', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1669651175, 1, 'Admin', 'istrator', 'ADMIN', '0'),
